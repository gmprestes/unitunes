...
namespace MongoDB.Web.Providers
{
    public class MongoDBRoleProvider : RoleProvider
    {
        ...
        public override string[] GetRolesForUser(string username)
        {
            ...
            var x = this.usersInRolesMongoCollection.FindAs<BsonDocument>(query).ToList().Select(bsonDocument => bsonDocument["Role"].AsString).ToArray(); ;
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            this.rolesMongoCollection = mongoClient.GetServer().GetDatabase(config["database"] ?? "ASPNETDB").GetCollection(config["collection"] ?? "Roles");
            this.usersInRolesMongoCollection = mongoClient.GetServer().GetDatabase(config["database"] ?? "ASPNETDB").GetCollection("UsersInRoles");
