...
namespace MongoDB.Bson.Serialization
{
    ...
    public class BsonMemberMap
    {
        ...
        /// <summary>
        /// Metodo criado que realiza o set do serializer desconsiderando a condição de frozen do objeto
        /// <para></para>
        /// Cuidado ao utlizar este metodo
        /// </summary>
        /// <param name="serializer"></param>
        /// <returns></returns>
        public BsonMemberMap ForceSetSerializer(IBsonSerializer serializer)
        {
            if (serializer == null)
            {
                throw new ArgumentNullException("serializer");
