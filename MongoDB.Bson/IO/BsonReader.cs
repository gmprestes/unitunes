...
namespace MongoDB.Bson.IO
{
    ...
    public abstract class BsonReader : IDisposable
    {
        ...
        protected void VerifyBsonType(string methodName, BsonType requiredBsonType)
        {
            ...
            bool forcedConversion = (_currentBsonType == BsonType.Int32 || _currentBsonType == BsonType.Int64 || _currentBsonType == BsonType.Double) && requiredBsonType == BsonType.String;

            if (_currentBsonType != requiredBsonType && !forcedConversion)
            {
                var message = string.Format(
