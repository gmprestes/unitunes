...
namespace MongoDB.Driver
{
    ...
    public abstract class MongoCollection
    {
        ...
        {
            var options = new MongoCreateIndexCommandOptions();
            options.background = true;
            return CreateIndex(IndexKeys.Ascending(keyNames), options);
        }
...
#pragma warning restore
        ...
        /// <summary>
        /// Metodo que procura os indexes solicitados
        /// </summary>
        /// <param name="keyNames"></param>
        /// <returns></returns>
        public string GetIndexName(string[] keyNames)
        {
            StringBuilder sb = new StringBuilder();
